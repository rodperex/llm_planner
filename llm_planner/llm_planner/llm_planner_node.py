...
class LLMPlannerNode(Node):
    ...
    def plan_task_callback(self, request, response):
        ...
        self.get_logger().info(f'[plan #{call_id}] Plan is ready. Printing plan details...')
        self.get_logger().info(
    ...
    def replan_task_callback(self, request, response):
        ...
        self.get_logger().info(f'[replan #{call_id}] Replan is ready. Printing plan details...')
        self.get_logger().info(
    ...
    def _build_endpoint(self):
        ...
        defaults = {
            ...
            'cerebras':  'https://api.cerebras.ai/v1/chat/completions',  # OpenAI-compatible, ensure API key is valid
        }
